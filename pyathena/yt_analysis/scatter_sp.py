...
def scatter_sp(sp,ax,axis=0,thickness=10,norm_factor=4.,
  type='slice',kpc=True,runaway=True,old='yes'):
    ...
    if len(sp) >0:
      ...
      if len(sp_runaway) > 0 and runaway:
        ...
        ax.scatter(spx,spy,marker='o',color='k',cmap='cool_r',alpha=1.0,s=10.0/norm_factor)
