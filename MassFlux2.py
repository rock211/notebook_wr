...
#plt.title('Mass Flux_UpperBound')
    ...
    if j==1:
        ...
        plt.ylabel(r'Mass flux [M$_{\odot}$ pc$^{-2}$ Myr$^{-1}$]', fontsize=26)
    if j==2:
...
#plt.axes().tick_params(which='major', direction='in',labelsize=22)
#plt.tight_layout(pad=0.3)
#plt.savefig('D:/yeongu/plots/massflux_No12_new2.png',dpi=400) # ,transparent=True

#plt.savefig('D:/yeongu/plots/massflux_No12_new2.eps',format='eps',dpi=400)
plt.show()
#plt.close()
